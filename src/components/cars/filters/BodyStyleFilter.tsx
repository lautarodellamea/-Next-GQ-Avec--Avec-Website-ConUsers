...
export const BodyStyleFilter = () => {
  ...
  return (
    <Accordion type="single" collapsible className="w-full bg-avecGrayColor pl-4 border-[1px] border-t-0 border-gray-400">
      <AccordionItem value="item-1">
        <AccordionTrigger className="text-avecBlueColor font-bold text-lg">Segmento</AccordionTrigger>
        <AccordionContent>
