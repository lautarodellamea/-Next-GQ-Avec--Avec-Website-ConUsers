...
export const FuelTypeFilter = () => {
  ...
  return (
    <Accordion type="single" collapsible className="w-full bg-avecGrayColor pl-4 border-[1px] border-gray-400">
      <AccordionItem value="item-1">
        <AccordionTrigger className="text-avecBlueColor font-bold text-lg">Combustible</AccordionTrigger>
        <AccordionContent>
