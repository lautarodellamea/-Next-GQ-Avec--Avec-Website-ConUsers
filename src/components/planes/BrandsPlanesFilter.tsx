...
export const BrandsPlanesFilter = () => {
  ...
  return (
    <>
      <p className='text-sm text-center sm:text-xl mb-4 sm:mb-8 opacity-80'>
        Seleccioná la marca del plan que buscás
      </p>
      ...
      <div className="flex flex-row gap-2 justify-around xl:justify-center xl:gap-20 items-center mb-4">
        ...
        >
          ...
          <img
            ...
            src="/images/plan-ahorro/logos/Logo Marca_Peugeot Plan_Vertical.svg"
            alt="Peugeot Plan"
          />
        </div>
        ...
        >
          ...
          <img
            ...
            src="/images/plan-ahorro/logos/Logo Marca_Citroën Plan.svg"
            alt="Citroën Plan"
          />
        </div>
        ...
        >
          ...
          <img
            ...
            src="/images/plan-ahorro/logos/Logo Marca_Fiat Plan.svg"
            alt="Fiat Plan"
          />
        </div>
