...
import { BrandsVentaDirectaFilter } from './BrandsVentaDirectaFilter';
import { getPaginatedCarVentaDirectaWithImages } from '@/actions/cars/car-pagination-venta-directa.action copy';
import { CarGridVentaDirecta } from './CarGridVentaDirecta';
...
export const CarsVentaDirecta = ({ searchParams }: Props) => {
  ...
  useEffect(() => {
    ...
    const fetchCars = async () => {
      const { cars, currentPage, totalPages } = await getPaginatedCarVentaDirectaWithImages({
        page,
        take: 12,
      ...
      <div className='flex flex-col gap-4 relative px-3'>
        ...
        <div >
          {loading ? (
            ...
            <>
              <CarGridVentaDirecta cars={carsData.cars} />
