...
export function FormCarPlan({ titleForm, serviceForm, isOpen, setIsOpen }: Props) {
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="sm:max-w-[425px] overflow-y-auto max-h-screen">
          <DialogHeader>
            ...
            <DialogDescription>
              Por favor rellená este formulario para realizar una consulta y nos pondremos en contacto contigo.
            </DialogDescription>
          </DialogHeader>
          <FormProvider {...form}>
