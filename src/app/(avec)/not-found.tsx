  ...
  return (
    <div className='flex flex-col-reverse items-center justify-center h-[100vh] p-3 container m-auto lg:flex-row'>
      <div className='xl:max-w-[500px]'>
        ...
        <h2 className={`text-3xl font-bold text-avecBlueColor uppercase lg:text-5xl ${avecFont.className} text-balance`}>Hubo un error en tu ruta</h2>
      ...
      <Image width={1000} height={1000} className='sm:max-w-[600px] mb-2' src="/images/Error_404_imagen.webp" alt="" />
    </div>
  )
}